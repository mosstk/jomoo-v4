...
const DesktopHeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-4 md:bottom-12 left-1/2 transform -translate-x-1/2 z-20 flex items-center space-x-2 md:space-x-3 bg-black/20 backdrop-blur-sm rounded-full px-3 py-1.5 md:px-4 md:py-2">
