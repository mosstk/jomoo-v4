...
const DesktopHeroSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-20 flex items-center space-x-3 bg-black/20 backdrop-blur-sm rounded-full px-4 py-2">
