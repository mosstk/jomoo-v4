...
const DesktopOnePieceToiletPage = () => {
  return (
    <div className="min-h-screen relative">
      ...
      <section className="bg-white py-4 w-[1120px] mx-auto">
        <div className="px-4">
          <p className="text-muted-foreground">Product &gt; One Piece Toilet</p>
        </div>
      </section>
      ...
      <section className="bg-white py-16 w-[1120px] mx-auto">
        <div className="px-4">
          <div className="grid grid-cols-3 gap-8 max-w-6xl mx-auto">
            {onePieceToiletProducts.map((product) => (
...
export default DesktopOnePieceToiletPage;