  ...
  return (
    <div className="min-h-screen relative">
      ...
      <section className="bg-white py-16 w-[1120px] mx-auto -mt-[50px]">
        <div className="px-4">
          <h2 className="text-2xl font-bold text-center mb-12 text-gray-900 whitespace-nowrap">TOA x JOMOO – Leaders in Global Innovation for Building Materials and Sanitaryware</h2>
